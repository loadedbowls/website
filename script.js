...
const translations = {
  nl: {
    ...
    formNote: "Levering kan binnen 8 km van Loaded Bowls in Gent. Bereiding en levering duren gemiddeld 25-30 minuten.",
    ...
    termsText: "Online bestellingen zijn pas definitief na betaling. Levering is mogelijk binnen 8 km van Sint-Amandstraat 24, 9000 Gent. Bereiding en levering duren gemiddeld 25-30 minuten, afhankelijk van drukte en bereikbaarheid. Afhalen kan tijdens de openingsuren. Prijzen en beschikbaarheid kunnen wijzigen.",
  ...
  en: {
    ...
    formNote: "Delivery is possible within 8 km of Loaded Bowls in Ghent. Preparation and delivery take around 25-30 minutes.",
    ...
    termsText: "Online orders are final after payment. Delivery is possible within 8 km of Sint-Amandstraat 24, 9000 Ghent. Preparation and delivery take around 25-30 minutes depending on traffic and workload. Pickup is possible during opening hours. Prices and availability may change.",
  ...
  fr: {
    ...
    formNote: "Livraison possible dans un rayon de 8 km autour de Loaded Bowls a Gand. Preparation et livraison prennent environ 25-30 minutes.",
  ...
  de: {
    ...
    formNote: "Lieferung ist innerhalb von 8 km von Loaded Bowls in Gent moeglich. Zubereitung und Lieferung dauern ca. 25-30 Minuten.",
