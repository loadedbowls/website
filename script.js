...
const translations = {
  nl: {
    ...
    orderNow: "Order now",
    directOrderBadge: "Voordeligst via onze site",
    directOrderTitle: "Afhalen of ter plaatse eten",
    directOrderCopy: "Bestel hier rechtstreeks aan onze voordeligste prijzen.",
    deliveryPartnerTitle: "Liever laten bezorgen?",
    ...
    heroMicro: "Bestel hier voordeliger voor afhalen of ter plaatse eten.",
    ...
    formNote: "Via onze website bestel je voor afhalen of ter plaatse eten. Voor bezorging kies je bovenaan een bezorgpartner.",
    findKicker: "/06 — Kom een bowl halen",
    findTitle: "Find the <span>drip.</span>",
    findCopy: "Eet gezellig ter plaatse of haal je bestelling af in Gent. Voor bezorging bestel je via Takeaway.com, Deliveroo of Uber Eats.",
    pickupOrder: "Bestel afhaal",
    route: "Route",
    whenTitle: "Wanneer?",
    copyright: "© 2026 Loaded Bowls. Alle rechten voorbehouden.",
    termsText: "Via deze website bestel je voor afhalen of ter plaatse eten. Online bestellingen zijn pas definitief na betaling. Bestellen voor bezorging verloopt via Takeaway.com, Deliveroo of Uber Eats. Prijzen en beschikbaarheid kunnen per verkoopkanaal verschillen.",
    ...
    checkingAddress: "We controleren of je binnen onze leverzone van 8 km ligt...",
    deliveryZoneError: "Levering kan enkel binnen 8 km van Loaded Bowls in Gent.",
    ...
    methods: ["Afhalen", "Ter plaatse eten"],
    payment: ["Online betalen", "Betalen bij afhalen / ter plaatse"]
  },
  en: {
    navBuild: "Build",
    navMenu: "Menu",
    ...
    navCheckout: "Checkout",
    orderNow: "Order now",
    directOrderBadge: "Best price on our website",
    directOrderTitle: "Pickup or eat in",
    directOrderCopy: "Order directly here at our best prices.",
    deliveryPartnerTitle: "Prefer delivery?",
    heroTitle: "Build it.<br><span>Load</span> it.<br>Devour it.",
    ...
    buildYourBowl: "Build your bowl",
    seeSignatures: "See signatures",
    heroMicro: "Order here for better pickup and eat-in prices.",
    ...
    formNote: "Use our website for pickup or eating in. For delivery, choose a delivery partner at the top of the page.",
    findKicker: "/06 — Come grab a bowl",
    findTitle: "Find the <span>drip.</span>",
    findCopy: "Eat in or pick up your order in Ghent. For delivery, order through Takeaway.com, Deliveroo or Uber Eats.",
    pickupOrder: "Order pickup",
    route: "Route",
    whenTitle: "When?",
    copyright: "© 2026 Loaded Bowls. All rights reserved.",
    termsText: "This website accepts pickup and eat-in orders. Online orders are final after payment. Delivery orders are placed through Takeaway.com, Deliveroo or Uber Eats. Prices and availability may differ by sales channel.",
    ...
    checkingAddress: "We are checking whether you are within our 8 km delivery zone...",
    deliveryZoneError: "Delivery is only possible within 8 km of Loaded Bowls in Ghent.",
    ...
    methods: ["Pickup", "Eat in"],
    payment: ["Pay online", "Pay at pickup / eat in"]
  },
  fr: {
    navBuild: "Composer",
    navMenu: "Menu",
    ...
    orderNow: "Commander",
    directOrderBadge: "Meilleur prix sur notre site",
    directOrderTitle: "A emporter ou sur place",
    directOrderCopy: "Commandez directement ici a nos meilleurs prix.",
    deliveryPartnerTitle: "Vous preferez la livraison?",
    ...
    heroMicro: "Commandez ici a prix avantageux, a emporter ou sur place.",
    ...
    formNote: "Notre site accepte les commandes a emporter ou sur place. Pour la livraison, choisissez un partenaire en haut de la page.",
    findKicker: "/06 — Viens chercher un bowl",
    findTitle: "Find the <span>drip.</span>",
    findCopy: "Mangez sur place ou retirez votre commande a Gand. Pour la livraison, commandez via Takeaway.com, Deliveroo ou Uber Eats.",
    pickupOrder: "Commander a emporter",
    route: "Itineraire",
    whenTitle: "Quand?",
    copyright: "© 2026 Loaded Bowls. Tous droits reserves.",
    termsText: "Ce site accepte les commandes a emporter ou sur place. Les commandes en ligne sont definitives apres paiement. Les livraisons passent par Takeaway.com, Deliveroo ou Uber Eats. Les prix et disponibilites peuvent varier selon le canal de vente.",
    ...
    checkingAddress: "Nous verifions si vous etes dans notre zone de livraison de 8 km...",
    deliveryZoneError: "La livraison est possible uniquement dans un rayon de 8 km autour de Loaded Bowls a Gand.",
    ...
    methods: ["A emporter", "Sur place"],
    payment: ["Paiement en ligne", "Payer au retrait / sur place"]
  },
  de: {
    navBuild: "Build",
    navMenu: "Menu",
    ...
    orderNow: "Bestellen",
    directOrderBadge: "Bester Preis auf unserer Website",
    directOrderTitle: "Abholen oder vor Ort essen",
    directOrderCopy: "Bestelle hier direkt zu unseren besten Preisen.",
    deliveryPartnerTitle: "Lieber liefern lassen?",
    heroTitle: "Build it.<br><span>Load</span> it.<br>Devour it.",
    ...
    heroMicro: "Bestelle hier guenstiger zur Abholung oder zum Essen vor Ort.",
    ...
    formNote: "Auf unserer Website bestellst du zur Abholung oder zum Essen vor Ort. Fuer Lieferung waehle oben einen Lieferpartner.",
    findKicker: "/06 — Komm eine Bowl holen",
    findTitle: "Find the <span>drip.</span>",
    findCopy: "Iss bei uns oder hole deine Bestellung in Gent ab. Fuer Lieferung bestellst du ueber Takeaway.com, Deliveroo oder Uber Eats.",
    pickupOrder: "Abholung bestellen",
    route: "Route",
    whenTitle: "Wann?",
    copyright: "© 2026 Loaded Bowls. Alle Rechte vorbehalten.",
    termsText: "Diese Website nimmt Bestellungen zur Abholung oder zum Essen vor Ort an. Online-Bestellungen sind nach Zahlung verbindlich. Lieferbestellungen laufen ueber Takeaway.com, Deliveroo oder Uber Eats. Preise und Verfuegbarkeit koennen je nach Verkaufskanal abweichen.",
    ...
    deliveryZoneError: "Lieferung ist nur innerhalb von 8 km von Loaded Bowls in Gent moeglich.",
    ...
    methods: ["Abholung", "Vor Ort essen"],
    payment: ["Online bezahlen", "Bei Abholung / vor Ort bezahlen"]
  }
};
...
orderForm.addEventListener("submit", async (event) => {
  ...
  const order = {
    ...
    promotion: "",
    total: summary.total,
    paymentMethod: selectedPaymentChoice === "later" ? "Betalen bij afhalen / ter plaatse" : "Online betalen"
  };
